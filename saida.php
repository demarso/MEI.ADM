...
<body class="bg-light">
  ...
  <div class="container" id="entrada">
    ...
    <font class="text-warning" face="Verdana" size="10px">Financeiro Despesas</font>
    <font class="text-info" face="Verdana" size="3px">      
    <form name="form1" method="post" action="saidaOK.php" >
      <!-- ********************************************************************************************************************** -->          
      ...
      <!-- ********************************************************************************************************************** -->           
          <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="nome">Descrição da Despesas:</label>
            <div class="col-md-6 mt-2">
             <input type="text" class="form-control" name="descricao" id="descricao" size="50" tabindex="1">
            </div>
          </div>
      <!-- ********************************************************************************************************************** -->          
          <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-10 mt-3">
              Dinheiro:&nbsp;&nbsp;&nbsp;<input type="text" id="valordi" name="valordi" size="8" onkeyup="maskIt(this,event,'###.###.###,##',true)" style="text-align: right;" PLACEHOLDER="Dinheiro" tabindex="2">&nbsp;&nbsp;&nbsp;
              Débito:&nbsp;&nbsp;&nbsp;<input type="text" id="valordb" name="valordb" size="8" onkeyup="maskIt(this,event,'###.###.###,##',true)"style="text-align: right;" PLACEHOLDER="Débito" tabindex="3">&nbsp;&nbsp;&nbsp;
              Crédito:&nbsp;&nbsp;&nbsp;<input type="text" id="valorcr" name="valorcr" size="8" onkeyup="maskIt(this,event,'###.###.###,##',true)"style="text-align: right;" PLACEHOLDER="Crédito" tabindex="4">&nbsp;&nbsp;&nbsp;
              Boleto:&nbsp;&nbsp;&nbsp;<input type="text" id="valorbl" name="valorbl" size="8" onkeyup="maskIt(this,event,'###.###.###,##',true)"style="text-align: right;" PLACEHOLDER="Boleto" tabindex="5">
            </div>
          </div>
      <!-- ********************************************************************************************************************** -->          
          <div class="form-group row mt-2 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="datacadA">Data da Despesas:</label>
            <div class="col-md-3">
              <input type="date" class="form-control" name="datasaida" id="datasaida" tabindex="6">
            </div>
          </div>
    		<!-- ********************************************************************************************************************** -->
		      <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-8 mt-2"> 
              <input type="text" name="recibo" id="recibo" size="10" tabindex="4" required="true" tabindex="7">
		        </div>
          </div>
       <!-- ********************************************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-8 mt-2">
		          <input type="text" name="observacao" id="observacao" size="60" tabindex="8" required="true">
		        </div>
          </div>
    		<!-- ********************************************************************************************************************** -->
          <div class="form-group row mt-2 mb-1">
