...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    <font class="text-warning" face="Verdana" size="10px">Cadastro de Serviços</font>
      ...
      <!-- **************************************************************************************************************** -->          
        ...
        <!-- **************************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-8">
		          <input type="text" name="servico" id="servico" size="60" tabindex="5" required="true" PLACEHOLDER="Digite o título do serviço">
		        </div>
          </div>
          <!-- **************************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="valor">Valor:</label>
            <div class="col-md-8">
              <input type="text" id="valor" name="valor" size="8" onkeyup="maskIt(this,event,'###.###.###,##',true)" style="text-align: right;" PLACEHOLDER="Valor do serviço">
            </div>
          </div>
           <!-- ********************************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-8">
              <input type="text" name="observacao" id="observacao" size="60" tabindex="5" required="true" PLACEHOLDER="Digite alguma observação sobre o serviço">
            </div>
          </div>
    		<!-- ******************************************************************************************************* -->
          <div class="form-group row mt-1 mb-1">
